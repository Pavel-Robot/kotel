...
//  LCD_IO_WriteCmd8(ILI9488_MADCTL); LCD_IO_WriteData8(0x48);
//  LCD_Delay(5);
  ...
  LCD_IO_WriteCmd8(ILI9488_IMCTR); LCD_IO_WriteData8(0x00); // Interface Mode Control (SDO NOT USE) 0x80
  #else
  ...
  #endif
  LCD_IO_WriteCmd8(ILI9488_FRMCTR1); LCD_IO_WriteData8(0xA0); //LCD_IO_WriteData8(0x16); // Frame rate (60Hz)
...
uint16_t ili9488_ReadID(void)
{
  ...
  #if ILI9488_INTERFACE == 0
  LCD_IO_ReadCmd8MultipleData8(0xD3, (uint8_t *)&id, 3, 0);
  id <<= 1;
  #elif ILI9488_INTERFACE == 1
